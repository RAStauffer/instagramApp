...
class Instagram {
   ...
   * @return mixed
   */
  public function getTagMedia($name, $minID, $limit = 0) {
	file_put_contents('activity.log', "MinID sent to getTagMedia = ".$minID."\r\n", FILE_APPEND);
    return $this->_makeCall('tags/' . $name . '/media/recent', false, array('min_tag_id' => $minID));
  }
  ...
  private function _makeCall($function, $auth = false, $params = null, $method = 'GET') {
	...
	file_put_contents('activity.log', $apiCall."\r\n", FILE_APPEND);
